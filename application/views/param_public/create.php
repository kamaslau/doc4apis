	...
	?>
		<fieldset>
			...
			<div class=form-group>
				...
				<div class=col-sm-10>
					<textarea class=form-control name=description rows=10 placeholder="说明" required><?php echo set_value('description') ?></textarea>
				</div>
			...
			<div class=form-group>
				...
				<div class=col-sm-10>
					<select class=form-control name=type required>
						<?php
							$options = array('string','int','float','boolean','timestamp');
							foreach ($options as $option):
						?>
						<option value="<?php echo $option ?>" <?php echo set_select('type', $option) ?>><?php echo $option ?></option>
						<?php endforeach ?>
					</select>
				</div>
			...
			<div class=form-group>
				<label for=required class="col-sm-2 control-label">是否必须</label>
				<div class=col-sm-10>
					<select class=form-control name=required required>
						<?php
							...
							foreach ($options as $option):
						?>
						<option value="<?php echo $option ?>" <?php echo set_select('required', $option) ?>><?php echo $option ?></option>
						<?php endforeach ?>
					</select>
				</div>
