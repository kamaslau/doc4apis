	...
	?>
		...
		<fieldset>
			<div class=form-group>
				...
				<div class=col-sm-10>
					<input class=form-control name=url type=url value="<?php echo $item['url'] ?>" placeholder="WEB URL">
				</div>
			...
			<div class=form-group>
				...
				<div class=col-sm-10>
					<input class=form-control name=url_ios type=url value="<?php echo $item['url_ios'] ?>" placeholder="iOS下载URL">
				</div>
			...
			<div class=form-group>
				...
				<div class=col-sm-10>
					<input class=form-control name=url_android type=url value="<?php echo $item['url_android'] ?>" placeholder="Android下载URL">
				</div>
