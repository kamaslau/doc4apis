	...
	?>
		<fieldset>
			<div class=form-group>
				...
				<div class=col-sm-10>
					<input class=form-control name=question type=text value="<?php echo $item['question'] ?>" placeholder="问题" required>
				</div>
			...
			<div class=form-group>
				...
				<div class=col-sm-10>
					<input class=form-control name=api_id type=text value="<?php echo $item['api_id'] ?>" placeholder="API ID">
				</div>
