...
<div id=content>
	...
	?>
		...
		<p class=text-center>点击“注册”，即表示您同意<a title="查看用户协议详细内容" href="<?php echo base_url('article/user-agreement') ?>" target=_blank>用户协议</a>。</p>
		<button class="btn btn-primary btn-lg btn-block" type=submit role=button>注册</button>
	</form>
	
	<a class="btn btn-vice btn-lg btn-block" title="登录" href="<?php echo base_url('login') ?>">登录</a>
