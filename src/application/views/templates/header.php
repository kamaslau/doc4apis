...
<html lang=zh-cn>
	<head>
		...
		<meta name=version content="revision20201231">
    ...
    <script src="<?php echo CDN_URL ?>jquery/jquery-3.5.1.min.js"></script>
    ...
    <link rel="stylesheet" href="<?php echo CDN_URL ?>bootstrap/3.4.1/bootstrap.min.css">
    <link rel="stylesheet" href="<?php echo CDN_URL ?>fontawesome/5.12.1/css/all.min.css">
