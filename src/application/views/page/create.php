...
<div id=content class="container-fluid">
	...
	<a class="btn btn-default" title="所有<?php echo $this->class_name_cn ?>" href="<?php echo base_url($this->class_name.'?project_id='.$project['project_id']) ?>"><i class="fal fa-list fa-fw"></i> 所有<?php echo $this->class_name_cn ?></a>
		<a class="btn btn-default" title="<?php echo $this->class_name_cn ?>回收站" href="<?php echo base_url($this->class_name.'/trash?project_id='.$project['project_id']) ?>"><i class="fal fa-trash fa-fw"></i> 回收站</a>
		<a class="btn btn-primary" title="创建<?php echo $this->class_name_cn ?>" href="<?php echo base_url($this->class_name.'/create?project_id='.$project['project_id']) ?>"><i class="fal fa-plus fa-fw"></i> 创建<?php echo $this->class_name_cn ?></a>
	</div>
	<?php endif ?>
	...
	?>
		<fieldset>
			...
			<div class=form-group>
				...
				<div class=col-sm-10>
					<input class=form-control name=name type=text value="<?php echo set_value('name') ?>" placeholder="页面名称，不加“页”字" required>
			...
			<div class=form-group>
				...
				<div class=col-sm-10>
					<input class=form-control name=code type=text value="<?php echo set_value('code') ?>" placeholder="例如：BIZ100；系统会自动将英文字母转为大写" required>
				</div>
			...
			<div class=form-group>
				...
				<div class=col-sm-10>
					...
					<button class="file-upload btn btn-primary btn-lg col-xs-12 col-md-3" data-target-dir=page data-selector-id=url_design data-input-name=url_design type=button><i class="fal fa-upload"></i> 上传</button>
			...
			<div class=form-group>
				...
				<div class=col-sm-10>
					<textarea class=form-control name=note_designer rows=3 placeholder="对于页面设计的补充说明或解释；最多255个字符"><?php echo set_value('note_designer') ?></textarea>
				</div>
			...
			<div class=form-group>
				...
				<div class=col-sm-10>
					...
					<textarea class=form-control name=events rows=20 placeholder="除载入事件外，页面内可以完成的功能"><?php echo set_value('events') ?></textarea>
				</div>
			...
			<div class=form-group>
				...
				<div class=col-sm-10>
					<textarea class=form-control name=note_developer rows=3 placeholder="对于技术开发的补充说明或解释；最多255个字符"><?php echo set_value('note_developer') ?></textarea>
				</div>
