<?php
	...
	{	
		...
		protected $names_to_sort = array(
			'user_id', 'password', 'nickname', 'lastname', 'firstname', 'code_ssn', 'url_image_id', 'gender', 'dob', 'avatar', 'mobile', 'email', 'wechat_union_id', 'address_id', 'bank_name', 'bank_account', 'time_create', 'time_delete', 'time_edit', 'last_login_timestamp', 'last_login_ip', 'operator_id',
...
// 			$this->basic->permission_check($role_allowed, $min_level);
			...
			$this->form_validation->set_rules('code_ssn', '身份证号', 'trim|required');
			$this->form_validation->set_rules('url_image_id', '身份证照片', 'trim|required');
			$this->form_validation->set_rules('gender', '性别', 'trim|required');
			$this->form_validation->set_rules('dob', '出生日期', 'trim|required');
			$this->form_validation->set_rules('avatar', '头像', 'trim|required');
			$this->form_validation->set_rules('mobile', '手机号', 'trim|');
			$this->form_validation->set_rules('email', '电子邮件地址', 'trim|required');
			$this->form_validation->set_rules('wechat_union_id', '微信用户的union_id', 'trim|required');
			$this->form_validation->set_rules('address_id', '默认地址ID', 'trim|required');
			...
			$this->form_validation->set_rules('last_login_timestamp', '最后登录时间', 'trim|required');
			$this->form_validation->set_rules('last_login_ip', '最后登录IP地址', 'trim|required');
