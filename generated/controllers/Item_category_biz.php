<?php
	...
	{	
		...
		protected $names_to_sort = array(
			'category_id', 'biz_id', 'parent_id', 'name', 'url_image', 'time_create', 'time_delete', 'time_edit', 'creator_id', 'operator_id',
...
// 			$this->basic->permission_check($role_allowed, $min_level);
			...
			$this->form_validation->set_rules('category_id', '商品分类ID', 'trim|');
			$this->form_validation->set_rules('biz_id', '所属商家企业ID', 'trim|');
			$this->form_validation->set_rules('parent_id', '所属分类ID', 'trim|required');
