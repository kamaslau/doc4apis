		...
		<fieldset>
			...
			<input name=id type=hidden value="<?php echo $item[$this->id_name] ?>">
						...
						<div class=form-group>
							...
							<div class=col-sm-10>
								<input class=form-control name=discount_promotion type=text value="<?php echo $item['discount_promotion'] ?>" placeholder="优惠活动折抵金额（元）" required>
							</div>
						</div>
						<div class=form-group>
						...
						<div class=form-group>
							...
							<div class=col-sm-10>
								<input class=form-control name=credit_id type=text value="<?php echo $item['credit_id'] ?>" placeholder="积分流水ID" required>
							</div>
						</div>
						<div class=form-group>
							<label for=discount_credit class="col-sm-2 control-label">积分折抵金额（元）</label>
							<div class=col-sm-10>
								<input class=form-control name=discount_credit type=text value="<?php echo $item['discount_credit'] ?>" placeholder="积分折抵金额（元）" required>
							</div>
						</div>
						<div class=form-group>
							<label for=freight class="col-sm-2 control-label">运费（元）</label>
							<div class=col-sm-10>
								<input class=form-control name=freight type=text value="<?php echo $item['freight'] ?>" placeholder="运费（元）" required>
							</div>
						</div>
						<div class=form-group>
							<label for=total class="col-sm-2 control-label">应支付金额（元）</label>
							<div class=col-sm-10>
								<input class=form-control name=total type=text value="<?php echo $item['total'] ?>" placeholder="应支付金额（元）" required>
							</div>
						</div>
						<div class=form-group>
							<label for=discount_teller class="col-sm-2 control-label">改价折抵金额（元）</label>
							<div class=col-sm-10>
								<input class=form-control name=discount_teller type=text value="<?php echo $item['discount_teller'] ?>" placeholder="改价折抵金额（元）" required>
							</div>
						</div>
						<div class=form-group>
							<label for=teller_id class="col-sm-2 control-label">改价操作者ID</label>
							<div class=col-sm-10>
								<input class=form-control name=teller_id type=text value="<?php echo $item['teller_id'] ?>" placeholder="改价操作者ID" required>
							</div>
						</div>
						<div class=form-group>
							<label for=total_payed class="col-sm-2 control-label">实际支付金额（元）</label>
							<div class=col-sm-10>
								<input class=form-control name=total_payed type=text value="<?php echo $item['total_payed'] ?>" placeholder="实际支付金额（元）" required>
							</div>
						</div>
						<div class=form-group>
							<label for=total_refund class="col-sm-2 control-label">实际退款金额（元）</label>
							<div class=col-sm-10>
								<input class=form-control name=total_refund type=text value="<?php echo $item['total_refund'] ?>" placeholder="实际退款金额（元）" required>
							</div>
						</div>
						<div class=form-group>
							<label for=addressee_fullname class="col-sm-2 control-label">收件人全名</label>
							<div class=col-sm-10>
								<input class=form-control name=addressee_fullname type=text value="<?php echo $item['addressee_fullname'] ?>" placeholder="收件人全名" required>
							</div>
						</div>
						<div class=form-group>
							<label for=addressee_mobile class="col-sm-2 control-label">收件人手机号</label>
							<div class=col-sm-10>
								<input class=form-control name=addressee_mobile type=text value="<?php echo $item['addressee_mobile'] ?>" placeholder="收件人手机号" required>
							</div>
						</div>
						<div class=form-group>
							<label for=addressee_province class="col-sm-2 control-label">收件人省份</label>
							<div class=col-sm-10>
								<input class=form-control name=addressee_province type=text value="<?php echo $item['addressee_province'] ?>" placeholder="收件人省份" required>
							</div>
						</div>
						<div class=form-group>
							<label for=addressee_city class="col-sm-2 control-label">收件人城市</label>
							<div class=col-sm-10>
								<input class=form-control name=addressee_city type=text value="<?php echo $item['addressee_city'] ?>" placeholder="收件人城市" required>
							</div>
						</div>
						<div class=form-group>
							<label for=addressee_county class="col-sm-2 control-label">收件人区/县</label>
							<div class=col-sm-10>
								<input class=form-control name=addressee_county type=text value="<?php echo $item['addressee_county'] ?>" placeholder="收件人区/县" required>
							</div>
						</div>
						<div class=form-group>
							<label for=addressee_address class="col-sm-2 control-label">收件人详细地址</label>
							<div class=col-sm-10>
								<input class=form-control name=addressee_address type=text value="<?php echo $item['addressee_address'] ?>" placeholder="收件人详细地址" required>
							</div>
						</div>
						<div class=form-group>
							<label for=payment_type class="col-sm-2 control-label">付款方式</label>
							<div class=col-sm-10>
								<input class=form-control name=payment_type type=text value="<?php echo $item['payment_type'] ?>" placeholder="付款方式" required>
							</div>
						</div>
						<div class=form-group>
							<label for=payment_account class="col-sm-2 control-label">付款账号</label>
							<div class=col-sm-10>
								<input class=form-control name=payment_account type=text value="<?php echo $item['payment_account'] ?>" placeholder="付款账号" required>
							</div>
						</div>
						<div class=form-group>
							<label for=payment_id class="col-sm-2 control-label">付款流水号</label>
							<div class=col-sm-10>
								<input class=form-control name=payment_id type=text value="<?php echo $item['payment_id'] ?>" placeholder="付款流水号" required>
							</div>
						</div>
						<div class=form-group>
							<label for=note_user class="col-sm-2 control-label">用户留言</label>
							<div class=col-sm-10>
								<input class=form-control name=note_user type=text value="<?php echo $item['note_user'] ?>" placeholder="用户留言" required>
							</div>
						</div>
						<div class=form-group>
							<label for=note_stuff class="col-sm-2 control-label">员工留言</label>
							<div class=col-sm-10>
								<input class=form-control name=note_stuff type=text value="<?php echo $item['note_stuff'] ?>" placeholder="员工留言" required>
							</div>
						</div>
						<div class=form-group>
							<label for=commission_rate class="col-sm-2 control-label">佣金比例/提成率</label>
							<div class=col-sm-10>
								<input class=form-control name=commission_rate type=text value="<?php echo $item['commission_rate'] ?>" placeholder="佣金比例/提成率" required>
							</div>
						</div>
						<div class=form-group>
							<label for=commission class="col-sm-2 control-label">佣金（元）</label>
							<div class=col-sm-10>
								<input class=form-control name=commission type=text value="<?php echo $item['commission'] ?>" placeholder="佣金（元）" required>
							</div>
						</div>
						<div class=form-group>
							<label for=promoter_id class="col-sm-2 control-label">推广者ID</label>
							<div class=col-sm-10>
								<input class=form-control name=promoter_id type=text value="<?php echo $item['promoter_id'] ?>" placeholder="推广者ID" required>
							</div>
						</div>
						<div class=form-group>
						...
						<div class=form-group>
							...
							<div class=col-sm-10>
								<input class=form-control name=time_cancel type=text value="<?php echo $item['time_cancel'] ?>" placeholder="用户取消时间" required>
							</div>
						</div>
						<div class=form-group>
							<label for=time_expire class="col-sm-2 control-label">自动过期时间</label>
							<div class=col-sm-10>
								<input class=form-control name=time_expire type=text value="<?php echo $item['time_expire'] ?>" placeholder="自动过期时间" required>
							</div>
						</div>
						<div class=form-group>
							<label for=time_pay class="col-sm-2 control-label">用户付款时间</label>
							<div class=col-sm-10>
								<input class=form-control name=time_pay type=text value="<?php echo $item['time_pay'] ?>" placeholder="用户付款时间" required>
							</div>
						</div>
						<div class=form-group>
							<label for=time_refuse class="col-sm-2 control-label">商家拒绝时间</label>
							<div class=col-sm-10>
								<input class=form-control name=time_refuse type=text value="<?php echo $item['time_refuse'] ?>" placeholder="商家拒绝时间" required>
							</div>
						</div>
						<div class=form-group>
							<label for=time_deliver class="col-sm-2 control-label">商家发货时间</label>
							<div class=col-sm-10>
								<input class=form-control name=time_deliver type=text value="<?php echo $item['time_deliver'] ?>" placeholder="商家发货时间" required>
							</div>
						</div>
						<div class=form-group>
							<label for=time_confirm class="col-sm-2 control-label">用户确认时间</label>
							<div class=col-sm-10>
								<input class=form-control name=time_confirm type=text value="<?php echo $item['time_confirm'] ?>" placeholder="用户确认时间" required>
							</div>
						</div>
						<div class=form-group>
							<label for=time_confirm_auto class="col-sm-2 control-label">系统确认时间</label>
							<div class=col-sm-10>
								<input class=form-control name=time_confirm_auto type=text value="<?php echo $item['time_confirm_auto'] ?>" placeholder="系统确认时间" required>
							</div>
						</div>
						<div class=form-group>
							<label for=time_comment class="col-sm-2 control-label">用户评价时间</label>
							<div class=col-sm-10>
								<input class=form-control name=time_comment type=text value="<?php echo $item['time_comment'] ?>" placeholder="用户评价时间" required>
							</div>
						</div>
						<div class=form-group>
							<label for=time_refund class="col-sm-2 control-label">商家退款时间</label>
							<div class=col-sm-10>
								<input class=form-control name=time_refund type=text value="<?php echo $item['time_refund'] ?>" placeholder="商家退款时间" required>
							</div>
						</div>
						<div class=form-group>
							<label for=time_delete class="col-sm-2 control-label">用户删除时间</label>
							<div class=col-sm-10>
								<input class=form-control name=time_delete type=text value="<?php echo $item['time_delete'] ?>" placeholder="用户删除时间" required>
							</div>
						</div>
						<div class=form-group>
						...
						<div class=form-group>
							...
							<div class=col-sm-10>
								<input class=form-control name=invoice_status type=text value="<?php echo $item['invoice_status'] ?>" placeholder="发票状态" required>
							</div>
						</div>
