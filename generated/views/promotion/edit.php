		...
		<fieldset>
			...
			<input name=id type=hidden value="<?php echo $item[$this->id_name] ?>">
						...
						<div class=form-group>
							...
							<div class=col-sm-10>
								<input class=form-control name=url_images type=text value="<?php echo $item['url_images'] ?>" placeholder="形象图URL们" required>
							</div>
						</div>
						<div class=form-group>
							<label for=url_web class="col-sm-2 control-label">活动页面URL</label>
							<div class=col-sm-10>
								<input class=form-control name=url_web type=text value="<?php echo $item['url_web'] ?>" placeholder="活动页面URL" required>
							</div>
						</div>
						<div class=form-group>
							<label for=brand_ids class="col-sm-2 control-label">参与活动的品牌ID们</label>
							<div class=col-sm-10>
								<input class=form-control name=brand_ids type=text value="<?php echo $item['brand_ids'] ?>" placeholder="参与活动的品牌ID们" required>
							</div>
						</div>
						<div class=form-group>
							<label for=biz_ids class="col-sm-2 control-label">参与活动的商家ID们</label>
							<div class=col-sm-10>
								<input class=form-control name=biz_ids type=text value="<?php echo $item['biz_ids'] ?>" placeholder="参与活动的商家ID们" required>
							</div>
						</div>
						<div class=form-group>
							<label for=item_ids class="col-sm-2 control-label">参与活动的商品ID们</label>
							<div class=col-sm-10>
								<input class=form-control name=item_ids type=text value="<?php echo $item['item_ids'] ?>" placeholder="参与活动的商品ID们" required>
							</div>
						</div>
						<div class=form-group>
						...
						<div class=form-group>
							...
							<div class=col-sm-10>
								<input class=form-control name=note_stuff type=text value="<?php echo $item['note_stuff'] ?>" placeholder="员工备注" required>
							</div>
						</div>
						<div class=form-group>
