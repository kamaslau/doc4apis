	...
	?>
		<fieldset>
			<legend>基本信息</legend>
							...
							<div class=col-sm-10>
								<input class=form-control name=template_id type=text value="<?php echo set_value('template_id') ?>" placeholder="模板ID" required>
							</div>
						</div>
						<div class=form-group>
						...
						<div class=form-group>
							<label for=category_id class="col-sm-2 control-label">限用系统级商品分类ID</label>
							<div class=col-sm-10>
								<input class=form-control name=category_id type=text value="<?php echo set_value('category_id') ?>" placeholder="限用系统级商品分类ID" required>
							</div>
						</div>
						<div class=form-group>
							<label for=category_biz_id class="col-sm-2 control-label">限用商家级商品分类ID</label>
							<div class=col-sm-10>
								<input class=form-control name=category_biz_id type=text value="<?php echo set_value('category_biz_id') ?>" placeholder="限用商家级商品分类ID" required>
							</div>
						</div>
						<div class=form-group>
							<label for=item_id class="col-sm-2 control-label">限用商品ID</label>
							<div class=col-sm-10>
								<input class=form-control name=item_id type=text value="<?php echo set_value('item_id') ?>" placeholder="限用商品ID" required>
							</div>
						</div>
						<div class=form-group>
						...
						<div class=form-group>
							...
							<div class=col-sm-10>
								<input class=form-control name=period type=text value="<?php echo set_value('period') ?>" placeholder="自领取时起有效期（秒）" required>
							</div>
						</div>
						<div class=form-group>
