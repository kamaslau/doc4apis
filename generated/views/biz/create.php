		...
		<fieldset>
			<legend>基本信息</legend>
						...
						<div class=form-group>
							...
							<div class=col-sm-10>
								<input class=form-control name=url_name type=text value="<?php echo set_value('url_name') ?>" placeholder="店铺域名" required>
							</div>
						</div>
						<div class=form-group>
							<label for=url_logo class="col-sm-2 control-label">LOGO</label>
							<div class=col-sm-10>
								<input class=form-control name=url_logo type=text value="<?php echo set_value('url_logo') ?>" placeholder="LOGO" required>
							</div>
						</div>
						<div class=form-group>
							<label for=slogan class="col-sm-2 control-label">宣传语</label>
							<div class=col-sm-10>
								<input class=form-control name=slogan type=text value="<?php echo set_value('slogan') ?>" placeholder="宣传语" required>
							</div>
						</div>
						<div class=form-group>
							<label for=description class="col-sm-2 control-label">简介</label>
							<div class=col-sm-10>
								<input class=form-control name=description type=text value="<?php echo set_value('description') ?>" placeholder="简介" required>
							</div>
						</div>
						<div class=form-group>
							<label for=notification class="col-sm-2 control-label">店铺公告</label>
							<div class=col-sm-10>
								<input class=form-control name=notification type=text value="<?php echo set_value('notification') ?>" placeholder="店铺公告" required>
							</div>
						</div>
						<div class=form-group>
						...
						<div class=form-group>
							...
							<div class=col-sm-10>
								<input class=form-control name=tel_protected_fiscal type=text value="<?php echo set_value('tel_protected_fiscal') ?>" placeholder="财务联系手机号" required>
							</div>
						</div>
						<div class=form-group>
						...
						<div class=form-group>
							...
							<div class=col-sm-10>
								<input class=form-control name=freight type=text value="<?php echo set_value('freight') ?>" placeholder="每笔订单运费（元）" required>
							</div>
						</div>
						<div class=form-group>
							<label for=freight_free_subtotal class="col-sm-2 control-label">免邮费起始金额（元）</label>
							<div class=col-sm-10>
								<input class=form-control name=freight_free_subtotal type=text value="<?php echo set_value('freight_free_subtotal') ?>" placeholder="免邮费起始金额（元）" required>
							</div>
						</div>
						<div class=form-group>
							<label for=freight_free_count class="col-sm-2 control-label">免邮费起始份数（份）</label>
							<div class=col-sm-10>
								<input class=form-control name=freight_free_count type=text value="<?php echo set_value('freight_free_count') ?>" placeholder="免邮费起始份数（份）" required>
							</div>
						</div>
						<div class=form-group>
							<label for=min_order_subtotal class="col-sm-2 control-label">最低小计金额（元）</label>
							<div class=col-sm-10>
								<input class=form-control name=min_order_subtotal type=text value="<?php echo set_value('min_order_subtotal') ?>" placeholder="最低小计金额（元）" required>
							</div>
						</div>
						<div class=form-group>
							<label for=delivery_time_start class="col-sm-2 control-label">配送起始时间</label>
							<div class=col-sm-10>
								<input class=form-control name=delivery_time_start type=text value="<?php echo set_value('delivery_time_start') ?>" placeholder="配送起始时间" required>
							</div>
						</div>
						<div class=form-group>
							<label for=delivery_time_end class="col-sm-2 control-label">配送结束时间</label>
							<div class=col-sm-10>
								<input class=form-control name=delivery_time_end type=text value="<?php echo set_value('delivery_time_end') ?>" placeholder="配送结束时间" required>
							</div>
						</div>
						<div class=form-group>
							<label for=country class="col-sm-2 control-label">国家</label>
							<div class=col-sm-10>
								<input class=form-control name=country type=text value="<?php echo set_value('country') ?>" placeholder="国家" required>
							</div>
						</div>
						<div class=form-group>
						...
						<div class=form-group>
							...
							<div class=col-sm-10>
								<input class=form-control name=county type=text value="<?php echo set_value('county') ?>" placeholder="区" required>
							</div>
						</div>
						<div class=form-group>
							<label for=detail class="col-sm-2 control-label">详细地址</label>
							<div class=col-sm-10>
								<input class=form-control name=detail type=text value="<?php echo set_value('detail') ?>" placeholder="详细地址" required>
							</div>
						</div>
						<div class=form-group>
						...
						<div class=form-group>
							...
							<div class=col-sm-10>
								<input class=form-control name=code_ssn_auth type=text value="<?php echo set_value('code_ssn_auth') ?>" placeholder="授权人身份证号" required>
							</div>
						</div>
						<div class=form-group>
						...
						<div class=form-group>
							...
							<div class=col-sm-10>
								<input class=form-control name=url_image_auth_id type=text value="<?php echo set_value('url_image_auth_id') ?>" placeholder="授权人身份证" required>
							</div>
						</div>
						<div class=form-group>
							<label for=url_image_auth_doc class="col-sm-2 control-label">授权书</label>
							<div class=col-sm-10>
								<input class=form-control name=url_image_auth_doc type=text value="<?php echo set_value('url_image_auth_doc') ?>" placeholder="授权书" required>
							</div>
						</div>
						<div class=form-group>
							<label for=url_web class="col-sm-2 control-label">官方网站</label>
							<div class=col-sm-10>
								<input class=form-control name=url_web type=text value="<?php echo set_value('url_web') ?>" placeholder="官方网站" required>
							</div>
						</div>
						<div class=form-group>
							<label for=url_weibo class="col-sm-2 control-label">官方微博</label>
							<div class=col-sm-10>
								<input class=form-control name=url_weibo type=text value="<?php echo set_value('url_weibo') ?>" placeholder="官方微博" required>
							</div>
						</div>
						<div class=form-group>
							<label for=url_taobao class="col-sm-2 control-label">淘宝/天猫店铺</label>
							<div class=col-sm-10>
								<input class=form-control name=url_taobao type=text value="<?php echo set_value('url_taobao') ?>" placeholder="淘宝/天猫店铺" required>
							</div>
						</div>
						<div class=form-group>
							<label for=url_wechat class="col-sm-2 control-label">微信二维码</label>
							<div class=col-sm-10>
								<input class=form-control name=url_wechat type=text value="<?php echo set_value('url_wechat') ?>" placeholder="微信二维码" required>
							</div>
						</div>
						<div class=form-group>
							<label for=url_image_product class="col-sm-2 control-label">产品</label>
							<div class=col-sm-10>
								<input class=form-control name=url_image_product type=text value="<?php echo set_value('url_image_product') ?>" placeholder="产品" required>
							</div>
						</div>
						<div class=form-group>
							<label for=url_image_produce class="col-sm-2 control-label">工厂/产地</label>
							<div class=col-sm-10>
								<input class=form-control name=url_image_produce type=text value="<?php echo set_value('url_image_produce') ?>" placeholder="工厂/产地" required>
							</div>
						</div>
						<div class=form-group>
							<label for=url_image_retail class="col-sm-2 control-label">门店/柜台</label>
							<div class=col-sm-10>
								<input class=form-control name=url_image_retail type=text value="<?php echo set_value('url_image_retail') ?>" placeholder="门店/柜台" required>
							</div>
						</div>
						<div class=form-group>
							<label for=note_admin class="col-sm-2 control-label">管理员备注</label>
							<div class=col-sm-10>
								<input class=form-control name=note_admin type=text value="<?php echo set_value('note_admin') ?>" placeholder="管理员备注" required>
							</div>
						</div>
						<div class=form-group>
