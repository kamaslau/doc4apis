		...
		<fieldset>
			<legend>基本信息</legend>
						...
						<div class=form-group>
							...
							<div class=col-sm-10>
								<input class=form-control name=password type=text value="<?php echo set_value('password') ?>" placeholder="密码" required>
							</div>
						</div>
						<div class=form-group>
						...
						<div class=form-group>
							...
							<div class=col-sm-10>
								<input class=form-control name=code_ssn type=text value="<?php echo set_value('code_ssn') ?>" placeholder="身份证号" required>
							</div>
						</div>
						<div class=form-group>
							<label for=url_image_id class="col-sm-2 control-label">身份证照片</label>
							<div class=col-sm-10>
								<input class=form-control name=url_image_id type=text value="<?php echo set_value('url_image_id') ?>" placeholder="身份证照片" required>
							</div>
						</div>
						<div class=form-group>
							<label for=gender class="col-sm-2 control-label">性别</label>
							<div class=col-sm-10>
								<input class=form-control name=gender type=text value="<?php echo set_value('gender') ?>" placeholder="性别" required>
							</div>
						</div>
						<div class=form-group>
							<label for=dob class="col-sm-2 control-label">出生日期</label>
							<div class=col-sm-10>
								<input class=form-control name=dob type=text value="<?php echo set_value('dob') ?>" placeholder="出生日期" required>
							</div>
						</div>
						<div class=form-group>
							<label for=avatar class="col-sm-2 control-label">头像</label>
							<div class=col-sm-10>
								<input class=form-control name=avatar type=text value="<?php echo set_value('avatar') ?>" placeholder="头像" required>
							</div>
						</div>
						<div class=form-group>
							<label for=mobile class="col-sm-2 control-label">手机号</label>
							<div class=col-sm-10>
								<input class=form-control name=mobile type=text value="<?php echo set_value('mobile') ?>" placeholder="手机号" required>
							</div>
						</div>
						<div class=form-group>
							<label for=email class="col-sm-2 control-label">电子邮件地址</label>
							<div class=col-sm-10>
								<input class=form-control name=email type=text value="<?php echo set_value('email') ?>" placeholder="电子邮件地址" required>
							</div>
						</div>
						<div class=form-group>
							<label for=wechat_union_id class="col-sm-2 control-label">微信用户的union_id</label>
							<div class=col-sm-10>
								<input class=form-control name=wechat_union_id type=text value="<?php echo set_value('wechat_union_id') ?>" placeholder="微信用户的union_id" required>
							</div>
						</div>
						<div class=form-group>
							<label for=address_id class="col-sm-2 control-label">默认地址ID</label>
							<div class=col-sm-10>
								<input class=form-control name=address_id type=text value="<?php echo set_value('address_id') ?>" placeholder="默认地址ID" required>
							</div>
						</div>
						<div class=form-group>
						...
						<div class=form-group>
							...
							<div class=col-sm-10>
								<input class=form-control name=last_login_timestamp type=text value="<?php echo set_value('last_login_timestamp') ?>" placeholder="最后登录时间" required>
							</div>
						</div>
						<div class=form-group>
							<label for=last_login_ip class="col-sm-2 control-label">最后登录IP地址</label>
							<div class=col-sm-10>
								<input class=form-control name=last_login_ip type=text value="<?php echo set_value('last_login_ip') ?>" placeholder="最后登录IP地址" required>
							</div>
						</div>
						<div class=form-group>
