	...
	?>
		<fieldset>
			<legend>基本信息</legend>
							...
							<label for=sku_id class="col-sm-2 control-label">SKU ID</label>
							<div class=col-sm-10>
								<input class=form-control name=sku_id type=text value="<?php echo set_value('sku_id') ?>" placeholder="SKU ID" required>
							</div>
						</div>
						<div class=form-group>
						...
						<div class=form-group>
							<label for=item_id class="col-sm-2 control-label">所属商品ID</label>
							<div class=col-sm-10>
								<input class=form-control name=item_id type=text value="<?php echo set_value('item_id') ?>" placeholder="所属商品ID" required>
							</div>
						</div>
						<div class=form-group>
						...
						<div class=form-group>
							...
							<div class=col-sm-10>
								<input class=form-control name=name_second type=text value="<?php echo set_value('name_second') ?>" placeholder="名称第二部分" required>
							</div>
						</div>
						<div class=form-group>
							<label for=name_third class="col-sm-2 control-label">名称第三部分</label>
							<div class=col-sm-10>
								<input class=form-control name=name_third type=text value="<?php echo set_value('name_third') ?>" placeholder="名称第三部分" required>
							</div>
						</div>
						<div class=form-group>
						...
						<div class=form-group>
							...
							<div class=col-sm-10>
								<input class=form-control name=weight_net type=text value="<?php echo set_value('weight_net') ?>" placeholder="净重（KG）" required>
							</div>
						</div>
						<div class=form-group>
							<label for=weight_gross class="col-sm-2 control-label">毛重（KG）</label>
							<div class=col-sm-10>
								<input class=form-control name=weight_gross type=text value="<?php echo set_value('weight_gross') ?>" placeholder="毛重（KG）" required>
							</div>
						</div>
						<div class=form-group>
							<label for=weight_volume class="col-sm-2 control-label">体积重（KG）</label>
							<div class=col-sm-10>
								<input class=form-control name=weight_volume type=text value="<?php echo set_value('weight_volume') ?>" placeholder="体积重（KG）" required>
							</div>
						</div>
						<div class=form-group>
