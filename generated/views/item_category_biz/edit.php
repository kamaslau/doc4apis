	...
	?>
		<fieldset>
			...
			<input name=id type=hidden value="<?php echo $item[$this->id_name] ?>">
							...
							<div class=col-sm-10>
								<input class=form-control name=category_id type=text value="<?php echo $item['category_id'] ?>" placeholder="商品分类ID" required>
							</div>
						</div>
						<div class=form-group>
							<label for=biz_id class="col-sm-2 control-label">所属商家企业ID</label>
							<div class=col-sm-10>
								<input class=form-control name=biz_id type=text value="<?php echo $item['biz_id'] ?>" placeholder="所属商家企业ID" required>
							</div>
						</div>
						<div class=form-group>
							<label for=parent_id class="col-sm-2 control-label">所属分类ID</label>
							<div class=col-sm-10>
								<input class=form-control name=parent_id type=text value="<?php echo $item['parent_id'] ?>" placeholder="所属分类ID" required>
							</div>
						</div>
						<div class=form-group>
