		...
		<fieldset>
			...
			<input name=id type=hidden value="<?php echo $item[$this->id_name] ?>">
						...
						<div class=form-group>
							...
							<div class=col-sm-10>
								<input class=form-control name=biz_id type=text value="<?php echo $item['biz_id'] ?>" placeholder="所属商户ID" required>
							</div>
						</div>
						<div class=form-group>
							<label for=password class="col-sm-2 control-label">员工操作密码</label>
							<div class=col-sm-10>
								<input class=form-control name=password type=text value="<?php echo $item['password'] ?>" placeholder="员工操作密码" required>
							</div>
						</div>
						<div class=form-group>
						...
						<div class=form-group>
							...
							<div class=col-sm-10>
								<input class=form-control name=time_edit type=text value="<?php echo $item['time_edit'] ?>" placeholder="最后编辑时间" required>
							</div>
						</div>
						<div class=form-group>
							<label for=creator_id class="col-sm-2 control-label">创建者user_id</label>
							<div class=col-sm-10>
								<input class=form-control name=creator_id type=text value="<?php echo $item['creator_id'] ?>" placeholder="创建者user_id" required>
							</div>
						</div>
						<div class=form-group>
							<label for=operator_id class="col-sm-2 control-label">最后操作者user_id</label>
							<div class=col-sm-10>
								<input class=form-control name=operator_id type=text value="<?php echo $item['operator_id'] ?>" placeholder="最后操作者user_id" required>
							</div>
						</div>
						<div class=form-group>
